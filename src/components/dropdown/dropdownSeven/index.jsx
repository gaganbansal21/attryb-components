...
function DropdownStaticDynamic({
  options,
  label,
  id,
  selectedVal,
    ...
    <div>
      <div>
        {!isStatic && (
          <div
            id=""
            className={`main-container-wrapper-class-main ${
              isFocused ? "" : ""
            }`}
          ...
          >
                ...
                <div id="" className="selected-value-part">
                  ...
                  <div id="" className="checker-inside-contianer-part">
                    ...
                    <span>
                      {isIcon && selectedVal && (
                        <img
                          src={currentselectedoption.icon.peopleIcon}
                          alt="person"
                          className="current-selected-option"
                        />
                      )}
                    </span>
                  </div>
            ...
            <div
              ...
              // onFocus={handleFocusIn}
            >
              <div className="static-selection-class">
                <div className="add-icon-static-clickable" onClick={handleStaticValue}>
                  <img
                    onClick={handleStaticValue}
                    src={AddIconsvg}
                    alt="add-icon"
                  />
                </div>
                <div className = "static-text-clickabel" onClick={handleStaticValue}><p>Use Static Selection</p></div>
              </div>
              {filter(options).map((option, index) => {
                return (
                  ...
                  >
                    <div
                      id="listdivitemoptionslabel"
                      className="options-data-single"
                    >
                      {isIcon && (
                        <img
        ...
        {!isOpen && selectedVal && (
          <div>
            <input type="text" className="on-selection-input"></input>
          </div>
        )}
      </div>
      ...
      <div>
        {isStatic && (
          <div>
            ...
            <div className="switcher-dropdown" onClick={handleStaticValue}>
              <p>Switch to Variable picker</p>
            </div>
          </div>
        )}
      </div>
...
export default DropdownStaticDynamic;
